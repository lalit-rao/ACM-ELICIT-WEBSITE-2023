    ...
    <div className="bg-black rounded-lg overflow-hidden flex transition-all duration-200 hover:scale-110 m-30 group">
        ...
        <div className="w-2/4 relative">
            <div
                ...
                <h3 className="text-purple-500 text-lg md:text-2xl font-bold text-center">{title}</h3>
                <p className="text-purple-500 text-sm md:text-md font-bold text-center mt-2">{date}</p>
                <p className="text-purple-500 text-sm md:text-md font-bold text-center mt-2">{time}</p>
            </div>
            <div
                ...
                <p className="text-white text-[9px] md:text-xs font-bold text-center mb-4">{description}</p>
                <a href={registerLink} target="_blank" rel="noopener noreferrer">
                    <button
                        className="bg-purple-500 text-white px-5 py-2 font-bold rounded-xl hover:bg-purple-700 transition-colors duration-300 text-xs">
                        Register
                    </button>
                </a>
            </div>
